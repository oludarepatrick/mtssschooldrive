...
<h4 class="head_bg_2"> SCHOOL THEME </h4>
<div class="flex-grid">
<div class="cell colspan3">
<div class="input-control file full-size" data-role="input">
        <input type="file" placeholder="Click Me to Upload THEME" name="userfile"  accept="image/*" onChange="showMyImage(this)">
...
<div class="heading">
        ...
        <span class="title">THEME INFO</span>
    </div>
	<div class="content">
<div class="flex-grid">
