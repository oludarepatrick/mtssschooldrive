...
<span class="mif-user icon "></span>
        <span class="title">Student Activation</span>
    </div>	
<div class="example1" data-text="example">
<form action="activate_student" method="post">
...
<div class="row flex-just-sb">
<div class="cell colspan3">
 <input type="submit" name="submit" id="submit" value="Activate"   class="button primary loading-cube" />
	</div>	
	</div>
	</div>
		</form>	
