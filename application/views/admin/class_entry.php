...
<form id="form1" name="form1" method="post" action="">
  <table width="57%" border="0" align="center">
    <tr>
      ...
      <td height="62" colspan="2" bgcolor="#66CC00"><span class="style36">CLASS ENTRY  </span></td>
    </tr>
    <tr>
      <td width="41%" height="48" bgcolor="#D1FFA4">New Class </td>
      <td width="59%" bgcolor="#D1FFA4"><span class="style29">
        <label></label>
        <label>
        <input name="enter_class" type="text" size="45" />
        </label>
      </span></td>
    </tr>
    <tr>
