...
<select id="class" class="select" name="class">
<option>SELECT CLASS</option>
</select>
</div>
<div class="cell colspan2">
<select id="class_division" class="select" name="class_division">
<option>SELECT DIVISION</option>
</select>
</div>
<div class="cell colspan2">
<select id="term" class="select" name="term">
...
<div class="cell colspan2">
<select id="session" class="select" name="session">
...
<div class="example1" data-text="example">
    ...
    <tbody>
      ...
      <p><b>Name: </b> <?php echo $result[0]->studentname; ?></p>
       ...
       <td><?php echo $result[$i]->totalscore; ?></td>
       </tr>
        <?php } ?>
        <tr><td colspan="4"><a target="blank" onclick="print_result()" href="print_result?term=<?php echo $result_details[2]; ?>&amp;session=<?php echo $result_details[3]; ?>&amp;class=<?php echo $result_details[0]; ?>&amp;class_division=<?php echo $result_details[1]; ?>&amp;student_id=<?php echo $result[1]->student_id; ?>" class="button success">Print Result</a>&nbsp;&nbsp;<a target="blank" onclick="print_result()" href="print_ca?term=<?php echo $result_details[2]; ?>&amp;session=<?php echo $result_details[3]; ?>&amp;class=<?php echo $result_details[0]; ?>&amp;class_division=<?php echo $result_details[1]; ?>&amp;student_id=<?php echo $result[1]->student_id; ?>" class="button success">Print CA</a></td></tr>
        </table>
        </div>
        </div>
