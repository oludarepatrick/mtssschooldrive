...
<?php foreach($schinfo->result() as $row)
	...
	<th style="color: #183292" colspan="3">First Term Summary</th>
	<th></th>
	<th></th>
	<th></th>
	</tr>
	...
	<td style="width: 40px"><img src="<?php echo base_url()."/uploads/result_labels/ca_total.gif"; ?>" /></td>
	<td style="width: 40px"><img src="<?php echo base_url()."/uploads/result_labels/exam.gif"; ?>" /></td>
	<td style="width: 40px"><img src="<?php echo base_url()."/uploads/result_labels/total.gif"; ?>" /></td>
	<td style="width: 40px"><img src="<?php echo base_url()."/uploads/result_labels/class_ave.gif"; ?>" /></td>
	<td style="width: 40px"><img src="<?php echo base_url()."/uploads/result_labels/grade.gif"; ?>" /></td>
	<td><p style="font-size: 11px; margin-left: 7px; color: #183292; font-weight:bold;">TEACHER&apos;S REMARK</p></td>
	</tr>
	<?php $j=0; foreach($result as $r) { ?>
	<tr>
	<td><p style="font-size: 11px; margin-left:10px; color: #183292; font-weight:bold;"><?php echo $r->subject; ?></p></td>
	<td><p style="font-size: 11px;"><?php echo $r->ca; ?></p></td>
	<td><p style="font-size: 11px;"><?php echo $r->exam; ?></p></td>
	<td><p style="font-size: 11px;"><?php echo $r->totalscore; ?></p></td>
	<td><p style="font-size: 11px;"><?php echo round($average_score[$j],2); ?></p></td>
...
<table border="1" id="student_details">
	...
	<div class="cell colspan1" style="margin-left: -40px; margin-right: 70px">
	...
	<div class="cell colspan1" style="margin-left: -50px; margin-right: 70px">
