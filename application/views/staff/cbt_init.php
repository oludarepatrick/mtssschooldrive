            ...
            <tbody>
                <?php $i=1; foreach($exams as $e) { ?>
                    <tr>
                        ...
                        <td><button class="button" onclick="location.href='/index.php/cbt/edit/<?php echo($e->id); ?>'">Edit Questions</button><button class="button exam-options" data-exam-id="<?php echo($e->id); ?>">Exam Options</button><!--<button class="button">View Exam</button>--></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
