...
<?php foreach($schinfo->result() as $row)
	...
	<p style="text-align: center;">MOCK RESULT&nbsp;&nbsp;<?php echo $session; ?>&nbsp;&nbsp;SESSION</p>
	<?php
	...
	<td style="width: 125px">MARKS (100%)</td>
	...
	<?php for($i=0;$i<count($grading);$i++) {
		if((int) $r->exam<=(int) $grading[$i]->higher && (int) $r->exam>=(int) $grading[$i]->lower) {
	...
	<p style="font-size: 11px; font-weight: bold; color: #183292">CLASS TEACHER'S COMMENT: </p>
	</div>
	...
	<div class="cell colspan3">
	    <p style="border-top: 1px #000; text-align: center;"><?php if(isset($date_sign[0]->signature)) {echo $date_sign[0]->signature;} ?></p>
		<p style="border-top: 1px dotted #000; text-align: center;">Principal's Signature</p>
	</div>
	<div class="cell colspan3"></div>
	<div class="cell colspan3">
	    <p style="border-top: 1px #000; text-align: center;"><?php if(isset($date_sign[0]->date)) {echo $date_sign[0]->date;} ?></p>
