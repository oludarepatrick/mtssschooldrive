            ...
            <tbody>
                <?php $i=1; foreach($exams as $e) { ?>
                    <tr>
                        ...
                        <td><button class="button" onclick="location.href='/index.php/cbt/edit_exam/<?php echo($e->id); ?>'">Edit Questions</button><button class="button exam-options" data-exam-id="<?php echo($e->id); ?>">Exam Options</button><!--<button class="button">View Exam</button>--></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
...
<script>
    ...
    $("#add-exam").on("click", function()
    {
        ...
        $.post('/index.php/cbt/create_exam',
        {
            'subject':  $('#subject').val(),
            'class':    $('#class').val(),
            'term':     $('#term').val()
    ...
    $('.exam-options').on('click', function()
    {
        ...
        $.post('/index.php/cbt/exam_options',
        {
            exam_id: exam_id
        },
        function(data){
    ...
    $('#edit-exam-option').on('click', function()
    {
        ...
        $.post('/index.php/cbt/update_exam',
        {
            exam_id: exam_id,
            time: exam_time,
            subject: subject,
