...
<?php foreach($schinfo->result() as $row)
	...
	<p style="text-align: center;">COMPUTER BASED TEST RESULT</p>
	<?php
	...
	<td style="width: 133px; font-weight:bold;">CBT(20)</td>
	<td style="width: 125px; font-weight:bold;">GRADE</td>
	<td style="width: 125px; font-weight:bold;">REMARKS</td>
	</tr>
	</thead>
	<tbody>
	...
	<td><p style="font-size: 10px;"><?php echo $r->ca1; ?></p></td>
	<td><p style="font-size: 11px;">
	<?php for($i=0;$i<count($grading);$i++) {
		if((int) $r->ca1<=(int) $grading[$i]->higher && (int) $r->ca1>=(int) $grading[$i]->lower) {
