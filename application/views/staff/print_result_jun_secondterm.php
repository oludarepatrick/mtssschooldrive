...
<?php foreach($schinfo->result() as $row)
	...
	<?php 
	    ...
	    //var_dump($firstTerm_subjects[$r->subject]);
	    //echo "<br/>---";
	...
	?>
	<td><p style="font-size: 10px;"><?php echo $firstTerm; ?></p></td>
	<td><p style="font-size: 10px;"><?php echo (double)$firstTerm+$r->totalscore; $totalCummScore+= (double)$firstTerm+$r->totalscore; ?></p></td>
	
	<td><p style="font-size: 10px;"><?php echo ((double)$firstTerm+$r->totalscore)/$divisor; ?></p></td>
