...
<?php $i++; } ?>
    ...
    function addQuestion()
    {
        ...
        QUESTIONS_CONTAINER.append('<div class="frame" id="question'+START_NUMBER+'"><div style="float: left"><textarea id="question'+START_NUMBER+'text"></textarea></div><div class="options" style="float: left; margin-left:20px; margin-top: 30px;"></div></div>');
        tinymce.init({
