...
<td>
<button class='small-button button success'><a target='blank' href='print_mock_result?session=<?php echo $session; ?>&amp;term=<?php echo $term; ?>&amp;student_id=<?php echo $student->student_id; ?>&amp;class=<?php echo $class;?>&amp;class_division=<?php echo $class_division; ?>'>View Result</a></button>
