...
<table class="table border bordered">
        ...
        <td><?php echo $result[$i]->ca1; ?></td>
       </tr>
        <?php } ?>
        <tr><td colspan="4"><a target="blank" onclick="print_cbt()" href="print_cbt?term=<?php echo $result_details[2]; ?>&amp;session=<?php echo $result_details[3]; ?>&amp;class=<?php echo $result_details[0]; ?>&amp;class_division=<?php echo $result_details[1]; ?>&amp;student_id=<?php echo $result[1]->student_id; ?>" class="button success">Print CBT</a></td></tr>
        </table>
        </div>
        </div>
...
$('.basic').fancySelect();
	$.post("getCBTResultSessions_Ajax",
        {
            check: 1
        },
        function(data1){
