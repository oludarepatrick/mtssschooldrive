...
<?php foreach($schinfo->result() as $row)
	...
	<td><p style="font-size: 10px;"><?php echo $first_result[$j]->totalscore+$second_result[$j]->totalscore+$r->totalscore; ?></p></td>
	<td><p style="font-size: 10px;"><?php echo round(($first_result[$j]->totalscore+$second_result[$j]->totalscore+$r->totalscore)/3,2); ?></p></td>
