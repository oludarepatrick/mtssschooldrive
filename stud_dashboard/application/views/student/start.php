    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="span4">
                ...
                <!--Body content-->
                <div   id="sidebar">
                    <p id="demo" class="slabel1" align="center" style="margin-bottom:3px"></p>
                    
                    <div align="center">
                        <img src="<?= $_SESSION['stud_pic']; ?>" class="img-circle" allt="img" style="width:180px; height:180px; background-image: url(<?=URL?>public/img/mas.png)" />
                    </div>
                    ...
                    <?php //echo ($timerDetail->t_timer)/60; ?>
