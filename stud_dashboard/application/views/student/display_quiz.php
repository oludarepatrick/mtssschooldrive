<?php 
    ...
    {
        $questTTT=preg_replace('/\s+/', ' ',$que['question']);
        //echo $que['queId'];
        $string = htmlentities($questTTT, null, 'utf-8');
        $content = str_replace("&nbsp;", "", $string);
        $content = html_entity_decode($content);
        
        $content=preg_replace( "/\r|\n/", "", $content );
        
        echo "<div style='font-size: 20px !important; font-family: Times New Roman;  line-height:25px !important; text-align:justify; margin-button:0px; padding-bottom:0px'>".$content."</div><br/>";
        //echo qLink.$que['mfile_ext'];
        ...
        {     
            ...
            {
                echo "<p><img src='".qLink.$que['mfile_ext']."' style='width:280px;height:230px'></p>";
            }
            elseif($ext=="mp3" || $ext=="mp4"){
                echo "<p>
                    <video width=\"280\" height=\"230\" controls>";
                    if($ext=="mp3"){
